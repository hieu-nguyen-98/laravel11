    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1">Edit Product <span class="text-danger">{{ $product->name }}</span></h4>
                    ...
                    <div class="card-body">
                        <div class="row mb-6">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" placeholder="Product title" name="name" value="{{ $product->name ?? '' }}">
                            </div>
                            <div class="col">
                                <label class="form-label">SKU</label> 
                                <input type="number" class="form-control" placeholder="SKU" name="sku" value="{{ $product->sku ?? '' }}">
                            </div>
                        </div>
                        <div class="mb-6">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" class="form-control" placeholder="Price" name="price" value="{{ number_format($product->price, 0, ',', '.') }}">
                        </div>
                        <!-- Discounted Price -->
                        <div class="mb-6">
